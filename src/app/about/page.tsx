  ...
  return (
    <>
      ...
      <section className="relative py-16 sm:py-24 md:py-32 overflow-hidden">
        ...
        <div className="absolute top-20 right-10 w-48 sm:w-72 h-48 sm:h-72 bg-ewc-burgundy/5 rounded-full blur-3xl" />
        <div className="relative section-container text-center">
          ...
          <h1 className="font-heading font-bold text-3xl sm:text-5xl lg:text-6xl text-ewc-charcoal mb-4 sm:mb-6 mt-3 px-2">
            ...
            <span className="block text-ewc-burgundy mt-1 sm:mt-2">Calgary</span>
          </h1>
      ...
      <section className="bg-white section-padding">
        <div className="section-container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8">
            <div className="card p-5 sm:p-8 border-l-4 border-l-ewc-burgundy">
              <div className="flex items-center gap-3 mb-4 sm:mb-6">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-amber-50 flex items-center justify-center">
                  <Eye size={22} className="text-ewc-burgundy" />
                </div>
                <h2 className="font-heading font-bold text-xl sm:text-2xl text-ewc-charcoal">Our Vision</h2>
              </div>
              <p className="text-ewc-slate leading-relaxed text-sm sm:text-base">
            ...
            <div className="card p-5 sm:p-8 border-l-4 border-l-ewc-burgundy">
              <div className="flex items-center gap-3 mb-4 sm:mb-6">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-amber-50 flex items-center justify-center">
                  <Target size={22} className="text-ewc-burgundy" />
                </div>
                <h2 className="font-heading font-bold text-xl sm:text-2xl text-ewc-charcoal">Our Mandate</h2>
              </div>
              <p className="text-ewc-slate leading-relaxed text-sm sm:text-base">
      ...
      <section className="bg-ewc-snow section-padding">
        <div className="section-container">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4 sm:space-y-5 text-ewc-slate leading-relaxed text-sm sm:text-[15px]">
              <p>
        ...
        <div className="section-container">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto">
            {coreValues.map((value) => (
              <div key={value.name} className="card text-center group p-4 sm:p-6">
                <div className={`w-11 h-11 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl ${value.color} mx-auto mb-3 sm:mb-4 flex items-center justify-center group-hover:scale-110 transition-transform`}>
                  <value.icon size={22} />
                </div>
                <h3 className="font-heading font-bold text-ewc-charcoal text-sm sm:text-lg mb-1 sm:mb-2">{value.name}</h3>
                <p className="text-ewc-silver text-xs sm:text-sm hidden sm:block">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="community-circles" className="bg-ewc-burgundy-50 section-padding">
        <div className="section-container">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 max-w-3xl mx-auto mb-8 sm:mb-12">
            {["Connection", "Conversation", "Care", "Accountability"].map((obj) => (
              <div key={obj} className="text-center p-4 bg-white rounded-2xl shadow-elevation">
                <p className="font-heading font-bold text-ewc-burgundy text-xs sm:text-sm uppercase tracking-wider">{obj}</p>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6">
            {communities.map((c) => (
              <div key={c.name} className="bg-white rounded-2xl p-4 sm:p-6 text-center shadow-soft hover:shadow-soft-lg transition-all group">
                <div className={`w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl ${c.lightBg} mx-auto mb-3 sm:mb-4 flex items-center justify-center group-hover:scale-110 transition-transform`}>
                  <div className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full ${c.dotColor}`} />
                </div>
                <h3 className={`font-heading font-bold text-base sm:text-lg mb-1 ${c.textColor}`}>{c.name}</h3>
                <p className="text-ewc-burgundy text-[10px] sm:text-xs font-heading mb-1 sm:mb-2">{c.verse}</p>
                <p className="text-ewc-silver text-[11px] sm:text-xs leading-relaxed hidden sm:block">{c.description}</p>
              </div>
            ))}
          </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative section-container py-16 sm:py-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4">
            ...
            <Link href="/volunteer" className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 border-2 border-white text-white font-heading font-semibold rounded-lg transition-all duration-300 hover:bg-white hover:text-ewc-charcoal text-sm uppercase tracking-wider active:scale-95">
              Get Involved
            </Link>
          </div>
        </div>
